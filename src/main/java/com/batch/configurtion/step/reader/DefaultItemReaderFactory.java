...
import com.batch.configurtion.step.reader.rule.BaseLineMapper;
...
public class DefaultItemReaderFactory<T> implements IReaderExector {
    private static final Logger log = LoggerFactory.getLogger(DefaultItemReaderFactory.class);
    ...
    public DefaultItemReaderFactory<T> setflatFileReader(FieldSetMapper<T> defaultFieldSet,BaseLineMapper<T> lineMapper) {
